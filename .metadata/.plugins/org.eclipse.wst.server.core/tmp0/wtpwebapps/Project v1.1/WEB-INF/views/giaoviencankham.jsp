     ...
     <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent no-bg sticky-top  ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <p class="navbar-brand" href="#pablo">Quản lý Giáo viên cần khám</p>
          </div>
                ...
                <div class="container-fluid">
                    ...
                    <li class="nav-item list-item">
                        <div class="dropdown show">
                          ...
                          <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="#">Sự cố sức khỏe 1</a>
                            <a class="dropdown-item" href="#">Sự cố sức khỏe 2</a>
                            <a class="dropdown-item" href="#">Something else here</a>
                          </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item list-item">
                            <button type="button" id="sidebarCollapse" class="btn btn-info" title="Danh sách các giáo viên cần khám">
