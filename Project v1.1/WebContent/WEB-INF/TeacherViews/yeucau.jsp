          ...
          <div class="collapse navbar-collapse" id="navigation">
            ...
            <!-- BAT DAU COPY NOTIFY TU DAY -->
              <li class="dropdown nav-item">
				...
				<a href="requestUserList?rnoti=read">
                      <div class="tile mb-3">
                        <div class="inline">
                          <div class="noti">
    ...
    <div class="wrapper">
        ...
        <div id="sidebar-cover">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/Error">Hồ sơ cá nhân</a>
                </li>
                 <li class="">
                    <a href="${pageContext.request.contextPath}/createUserRequest">Đăng ký khám</a>
                </li>
        ...
        <div class="card card-body">
           <form method="post" action="createUserRequest">
               <div class="form-row">
        ...
        <div class="card ">
              <div class="card-header">
                <h4> Danh sách Giáo viên cần khám</h4>
              </div>
               <div class="card-body">
                <div class="table-responsive">
                  <table class="table tablesorter " id="">
                    ...
                    <tr>
                      ...
                      <th scope="col">Thay đổi thời gian</th>
                      <th scope="col">Xóa</th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <c:forEach items="${requestList}" var="request">
                      ...
                      <td>R${request.requestId }</td>
                      <td>${request.time }</td>
                      <td>${request.date }</td>
                      <td>${request.status }</td>
                      <td><a href="setStatus?status=Chờ khám&id=${request.requestId}"><button class="btn btn-warning" type="button">Đổi lịch</button></a> 
                      </td> <!-- button Sửa -->
