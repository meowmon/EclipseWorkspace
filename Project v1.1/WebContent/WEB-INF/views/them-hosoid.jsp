...
<%request.setCharacterEncoding("UTF-8"); %>
    ...
    <div class="wrapper">
        ...
        <div class="">
            ...
            <form class="card-body card" method="post" action="createExamfileId" >
            <p style="color: red;">${errorString}</p>
              <div class="form-row">
                <div class="col-md-6">
                  <label for="staticEmail" class="col-md-4 col-form-label auto-w">Họ tên :</label>
                  <input type="text" name ="name" readonly class=" col-form-label auto-w no-margin" id="staticEmail" value="<%= request.getParameter("name") %>">
                  </div>
                  <div class="col-md-6">
                  <label for="staticEmail" class="col-md-4 col-form-label auto-w">Mã giáo viên :</label>
                  <input type="text" name ="userId" readonly class=" col-form-label auto-w no-margin" id="staticEmail" value="<%= request.getParameter("id") %>">
                  </div>
            </div>
            <div class="form-row">
