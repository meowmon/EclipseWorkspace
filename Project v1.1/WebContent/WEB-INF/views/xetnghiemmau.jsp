           ...
           <form>
            <div class="border-gray">
                <div class="border-gray">
                    ...
                    <div class="line_20"></div>
                      <div class="form-row">
                        <div class="col-md-2 mb-5">
                          ...
                          <input type="text" class="form-control" id="validationDefault01" placeholder="Nhóm máu" value="${report.nhomMau}" readonly>
                      </div> 
                      </div>  
                      ...
                      <div class="form-row">
                        ...
                        <div class="col-md-2 mb-2">
                          ...
                          <input type="text" class="form-control" id="validationDefault01" placeholder="WBC" value="${report.WBC}" readonly>
                        </div>
                        <div class="col-md-2 mb-2">
                          <label for="validationDefault01">RBC</label>
                          <input type="text" class="form-control" id="validationDefault01" placeholder="WBC" value="${report.RBC}" readonly>
                        </div>
                        <div class="col-md-2 mb-2">
                          <label for="validationDefault01">HB</label>
                          <input type="text" class="form-control" id="validationDefault01" placeholder="HB" value="${report.HB}" readonly>
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="col-md-2 mb-5">
                          <label for="validationDefault01">HCT</label>
                          <input type="text" class="form-control" id="validationDefault01" placeholder="HCT" value="${report.HCT}" readonly>
                        </div>
                        <div class="col-md-2 mb-5">
                          <label for="validationDefault01">MCV</label>
                          <input type="text" class="form-control" id="validationDefault01" placeholder="MCV" value="${report.MCV}" readonly>
                        </div>
                        <div class="col-md-2 mb-5">
                          <label for="validationDefault01">MCH</label>
                          <input type="text" class="form-control" id="validationDefault01" placeholder="MCH" value="${report.MCH}" readonly>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="form-row">
                    <div class="col-md-6 mb-3">
                      ...
                      <textarea class="form-control" aria-label="Mô tả" value="${report.descrip}" readonly></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-row">
                    <div class="col-md-6 mb-3">
                      ...
                      <textarea class="form-control" aria-label="Mô tả" value="${report.dieutri}" readonly></textarea>
                    </div>
                  </div>
                ...
                <div class="col-md-8 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationDefault01" placeholder="MCH" value="${report.tenbenh}" readonly>
              </div>
              </div>
