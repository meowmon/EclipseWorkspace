     ...
     <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent no-bg sticky-top  ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <p class="navbar-brand" href="#pablo">Thêm Khoa</p>
          </div>
           ...
           <form method="POST" action="${pageContext.request.contextPath}/createDepartment">
             <div class="form-row">
                <div class="col-md-6 mb-3">
                  ...
                  <input type="name" name="name" class="form-control" id="name" placeholder="Tên Khoa" value="${department.name}">
              ...
              <div class="form-row">                  
                <div class="col-md-3 mb-3">
                  ...
                  <select id="status" name="status" value="${department.status}" id="inputState" class="form-control">
              ...
              <a href="departmentList"><button class="btn btn-default" type="button">Hủy bỏ</button></a>
