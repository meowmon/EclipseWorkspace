     ...
     <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent no-bg sticky-top  ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <p class="navbar-brand" href="#pablo">Quản lý Hồ sơ Khám nội</p>
          </div>
             ...
             <form>
                  ...
                  <div class="form-row">
                    <div class="col-md-3 mb-3">
                        ...
                        <div class="input-group">
                          <input type="text" class="form-control" id="validationDefault01" placeholder="Chiều cao" value="" required>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <div class="input-group">
                          <input type="text" class="form-control" id="validationDefault01" placeholder="Cân nặng" value="" required>
                          <div class="input-group-append">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <div class="input-group">
                          <input type="text" class="form-control" id="validationDefault01" placeholder="Mạch" value="" required>
                          <div class="input-group-append">
                ...
                <div class="form-row">
                    <div class="col-md-3 mb-2">
                        ...
                        <div class="input-group">
                          <input type="text" class="form-control" id="validationDefault01" placeholder="Huyết áp" value="" required>
                          <div class="input-group-append">
                     ...
                     <div class="col-md-4 mb-2">
                        <label for="validationDefault01">Phân loại thể lực</label>
                          <input type="text" class="form-control" id="validationDefault01" placeholder="Phân loại thể lực" value="" required>
                        </div>
                    </div>
                </div>
              ...
              <div class="form-row">
                <div class="col-md-9 mb-3">
                  ...
                  <textarea class="form-control" aria-label="Mô tả"></textarea>
                </div>
              </div>
