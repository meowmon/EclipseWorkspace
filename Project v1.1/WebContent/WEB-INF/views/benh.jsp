     ...
     <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent no-bg sticky-top  ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <p class="navbar-brand" href="#pablo">Quản lý Bệnh</p>
          </div>
                    ...
                    <li class="nav-item list-item">
                       <div class="dropdown show above" >
                          ...
                          <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="#">Loại bệnh 1</a>
                            <a class="dropdown-item" href="#">Loại bệnh 2</a>
                  ...
                  <tbody>
                    ...
                    <c:forEach items="${diseaseList}" var="disease" >
                      <tr>
                        ...
                        <td>${disease.diseaseTypeId}</td>
                        <td>${disease.descrip}</td>
                        <td>${disease.status}</td>
                        <td><a href="sua-benh.html"><i class="fas fa fa-edit"></i></a></td> <!-- button Sửa -->
